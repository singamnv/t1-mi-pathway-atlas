...
2. sends the submission to **admin@coronaryatlas.com** via SES,
...
aws ses verify-email-identity --email-address admin@coronaryatlas.com --region us-east-1
...
- IAM role can **only** call `ses:SendEmail` from `admin@coronaryatlas.com`.
